...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new expire name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/expire.png')) {
        fs.renameSync(__dirname + '/admin/expire.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/expire.html')) {
        fs.renameSync(__dirname + '/widgets/expire.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/expire/js/expire.js')) {
        fs.renameSync(__dirname + '/widgets/expire/js/expire.js', __dirname + '/widgets/expire/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/expire')) {
        fs.renameSync(__dirname + '/widgets/expire',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /expire/g,
        ...
        {
            match: /Expire/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Expire'
        },
        {
            match: /shady2k/g,
            replacement: author
